...
# but a higher value is required for conditions such as nitrate deficiency.
...
# Masking and Extraction of spectral data. Adjust threshold values as needed 
...
spectra_per_area.index = [f"{label}_{area}" for area in ['whole', 'peripheral', 'paracentral', 'central'] for label in location['label']]

# Call the specim plot function
specim_plot(spectra_per_area, path)
