...
Figure 0: Spatial-spectral characteristics of M. polymorpha under different nutrient deficiency. (A) Summary of data collections. The minimal enclosing circle of leaf area was divided evenly into three areas as indicated by the yellow dotted lines, namely central, paracentral and peripheral regions. (B-F) Representative thallus images at day 14 of nutrient deficiency treatment. Scale bar is 1 cm. Reflectance spectra from the whole, central, paracentral, and peripheral areas of thallus are shown on the right. The graphs show the mean values (solid lines) of thallus reflectance with s.d. (translucent bands). Green, red and blue dashed lines indicate absorption wavelengths for chlorophyll, anthocyanin and water respectively.  
